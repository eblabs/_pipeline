#################################################
# leg fk module
# this module should do the base biped leg fk rig
#################################################
## import
...
class legFkModule(baseFkChainLimb.baseFkChainLimb):
	...
	def __init__(self, *args, **kwargs):
		super(legFkModule, self).__init__(*args, **kwargs)
		if args:
	...
	def createComponent(self):
		...
		cmds.setAttr('%s.sComponentType' %self._sComponentMaster, 'legFkModule', type = 'string', lock = True)
